...
func TestConfigRoundTrip(t *testing.T) {
	...
	if got.ServerName != "lab" || got.Runtime.Backend != "podman" || got.Inference.BasePath != "/openai/v1" || got.Machine.MemoryMax != "32g" {
...
func TestLoadStartsFromDefaults(t *testing.T) {
	...
	if cfg.ServerName != "lab" || cfg.Runtime.Backend != "podman" || cfg.Machine.MemoryMax != "32g" {
