...
- Product/release planning work should map back to one of the four pillars in [`product/vision.md`](product/vision.md): site layout, machine capabilities + validation, serving recipes, or the SSH TUI experience. Cross-cutting work (security, packaging, CI, bug fixes) is exempt.
